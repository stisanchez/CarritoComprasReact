...
export const MyContextProvider = () => {
  ...
  return (
    <DataContext.Provider value={{ usuario, setUsuario, cantidadCarrito: carritoFinal.length, setCarrito_Function, carritoFinal, cambiarCantidad, eliminarDelCarrito, setVoucher, voucher }}>
